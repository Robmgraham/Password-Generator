...
alert("Now lets choose its contents");
     ...
     confirm ("Would you like  to include CAPTIAL CASE letters")
       if (true) {const randomElement = capitalCase[Math.floor(Math.random()* 8)];
           
       } else {
           
       }
    confirm("Would you like to include lower case letters")
       if (true) {const randomElement = lowerCase[Math.floor(Math.random()* 8)];
           
       } else {
           
       }
    confirm("would you like to include special characters")
        if (true) {const randomElement = specialChar[Math.floor(Math.random()* 8)];
            
        } else {
            
        }
    confirm("would you like to include numbers");
    if (true) {const randomElement = numbers[Math.floor(Math.random()* 8)];
